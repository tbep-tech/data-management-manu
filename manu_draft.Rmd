...
```{r, out.width = '100%'}
knitr::include_graphics('figs/editme2.PNG')
```
...
```{r, out.width = '100%'}
knitr::include_graphics('figs/editme3.PNG')
```
...
```{r, out.width = '100%'}
knitr::include_graphics('figs/issues.PNG')
```
...
knitr::include_graphics('figs/michener.png')
```
...
knitr::include_graphics('figs/oysters.jpg')
```
...
knitr::include_graphics('figs/oysterexcel.PNG')
```
...
knitr::include_graphics('figs/deepwater.jpg')
```
...
knitr::include_graphics('figs/desotoshiny.PNG')
```

```{r, out.width = '80%', fig.cap = 'Red tide *Karenia brevis* on the Gulf Coast of Florida (image credit: NOAA)'}
knitr::include_graphics('figs/red tide.jpg')
```

```{r redtidereadme, out.wdith = '90%', fig.cap = 'The README file for the GitHub repository, including relevant data products to evaluate Twitter responses to red tide. Available at <https://github.com/tbep-tech/red-tide-twitter>.'}
knitr::include_graphics('figs/redtidereadme.PNG')
```
